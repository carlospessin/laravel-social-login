...
<p>A sua privacidade é importante para nós. É política do localhost respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href=https://localhost:8000 />localhost</a>, e outros sites que possuímos e operamos.</p>
...
<h2>Política de Cookies localhost</h2>
...
<p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o localhost oferece no site e com caráter enunciativo, mas não limitativo:</p>
<ul>
    ...
    <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do localhost, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
</ul>
